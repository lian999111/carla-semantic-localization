...
class BehaviorAgent(Agent):
    ...
    def update_information(self, ego_veh):
        """
        This method updates the information regarding the ego
        vehicle based on the surrounding world.

            :param ego_veh: carla.Actor of ego vehicle.
        """
        self.speed = get_speed(self.vehicle)
        self.speed_limit = ego_veh.get_speed_limit()
        ...
        self.is_at_traffic_light = ego_veh.is_at_traffic_light()
